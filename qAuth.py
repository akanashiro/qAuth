...
class Ui_qAuthClass(object):
    ...
    def loadData(self):
        ...
        for row_number, row_data in enumerate(resultQuery):
            ...
            for column_number, data in enumerate(row_data):
                ...
                # Remove OTP
                self.tblKeys.setCellWidget(row_number, 3, self.btn_Remove)
    ...
    def setupUi(self, qAuthClass):
        ...
        self.tblKeys.setMaximumSize(QtCore.QSize(550, 16777215))
        ...
        self.tblKeys.setColumnWidth(1,150)
        ...
        self.btn_Remove.setMaximumWidth(34)
        self.btn_Remove.clicked.connect(self.removeOTP)
    ...
    def retranslateUi(self, qAuthClass):
        ...
        self.btn_Remove.setIcon(QtGui.QIcon.fromTheme('list-remove'))
